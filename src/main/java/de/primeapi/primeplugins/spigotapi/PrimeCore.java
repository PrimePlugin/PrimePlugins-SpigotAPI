...
import de.primeapi.primeplugins.spigotapi.api.error.controller.TroubleController;
...
public class PrimeCore extends JavaPlugin {
    ...
    private TroubleController troubleController;
    ...
    public void onEnable() {
        ...
        troubleShooter = new TroubleShooter();
        troubleController = new TroubleController();
        ...
        if (!mysql) {
            troubleController.addError(new ErrorObject(Messages.MYSQL_NOT_CONNECTED, ErrorTypes.FATAL));
        } else {troubleShooter.done();}
    ...
    private void initSql() {
        try {
            ...
            connection.prepareStatement("CREATE TABLE IF NOT EXISTS `core_settings` (" + "`id` INT NOT NULL AUTO_INCREMENT UNIQUE," + "`uuid` VARCHAR(36) NOT NULL," + "`setting` VARCHAR(36) NOT NULL," + "`value` INT," + "PRIMARY KEY (`id`));").execute();
